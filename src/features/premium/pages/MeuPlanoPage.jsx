    ...
    <>
      ...
      <div className="mx-auto flex max-w-2xl flex-col gap-4 p-4 md:p-8">
        <div className="rounded-card bg-white p-5 shadow-card dark:bg-ink-700">
          ...
          <p className="text-sm text-ink-500">{hasProAccess ? 'Funções Pro desbloqueadas permanentemente e anúncios removidos.' : 'Use os recursos essenciais gratuitamente com anúncios.'}</p>
        </div>
