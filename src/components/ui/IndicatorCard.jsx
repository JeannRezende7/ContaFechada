...
export default function IndicatorCard({ label, value, tone = 'neutral', hint, icon: Icon }) {
  const t = TONES[tone];
  return (
    <div className="bg-white dark:bg-ink-700 rounded-card shadow-card hover:shadow-card-hover transition-shadow p-2 sm:p-4 md:p-5 flex flex-col items-center gap-1 sm:gap-2 min-w-0 text-center">
      ...
      <span className={`money w-full text-center text-sm sm:text-xl md:text-2xl font-semibold leading-tight break-all ${t.text}`}>
